...
and sort of $\mathrm{PathT}$ is Type and these two definitions exist for extraction purpose,  
terms of sort Prop are erased and terms of sort Type appear in the OCaml code).
